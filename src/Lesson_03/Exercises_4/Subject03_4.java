...
public class Subject29_4 {
    public static void main(String[] args) {
        ...
        if (n <= 0) {
            ...
            SubjectSP29_4[] subject = new SubjectSP29_4[n];  //tạo đối tượng cho lớp SubjectSP29_4
            fillSubjects(subject, input);
            showSubjects(subject);
        }
    }

    private static void showSubjects(SubjectSP29_4[] subject) {
     ...
     */
    private static void fillSubjects(SubjectSP29_4[] subject, Scanner input) {
        for (int i = 0; i <= subject.length - 1; i++) {
            SubjectSP29_4 monhoc = new SubjectSP29_4();
