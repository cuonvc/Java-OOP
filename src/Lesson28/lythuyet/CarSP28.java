public class CarSP28 {
    ...
    public CarSP28(String name) {
        this.name = name;
        CarShow28.showInfo(this); //giữ nguyên cái show name ở carShow28 và chuyển dòng này qua từng
    ...
    public CarSP28(String name, float weight) {
        this.name = name;
        this.weight = weight;
    }

    //constructor có 3 tham số
    public CarSP28(String name, float weight, long year) {
        this.name = name;
        this.weight = weight;
        this.year = year;
    }
    ...
    public CarSP28(String name, float weight, long year, String type) {
